...
import { createForm, onFieldChange, onFieldMount, onFieldReact } from '@formily/core';
    ...
    return createForm({
      ...
      effects() {
        ...
        onFieldReact('total', (field) => {
          umiConsole.log('total recompute');
