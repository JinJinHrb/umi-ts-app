...
import { StyledH1, StyledP, StyledCounterSpan } from '@/pages/demoForm/hookForm/cases/styled';

export default ({ renderCount, description }: { renderCount?: number; description?: string }) => (
  <>
    <StyledCounterSpan className="counter">Render Count: {renderCount}</StyledCounterSpan>
    <StyledH1>
      <svg
        width="40px"
        height="40px"
    ...
    <StyledP style={{ fontSize: 14, lineHeight: 1.3 }}>{description}</StyledP>
  </>
);
