...
import { DeleteOutlined, DownOutlined, UpOutlined, PlusOutlined, MenuOutlined } from '@ant-design/icons';
...
import { usePrefixCls } from '@/utils/__builtins__';
...
ArrayBase.Item = ({ children, ...props }) => {
  return (
    <ItemContext.Provider value={props}>
      <ExpressionScope value={{ $record: props.record, $index: props.index }}>{children}</ExpressionScope>
